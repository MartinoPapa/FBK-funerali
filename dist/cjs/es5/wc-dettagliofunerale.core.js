...
} var s = e.namespace || "WcDettagliofunerale"; return L || (L = !0, function l(n, t, e) { (n["s-apps"] = n["s-apps"] || []).push(t), e.componentOnReady || (e.componentOnReady = function t() { function e(t) { if (r.nodeName.indexOf("-") > 0) {
...
var c = "$", a = {}, s = { enter: 13, escape: 27, space: 32, tab: 9, left: 37, up: 38, right: 39, down: 40 }, l = function (t, e, r, i) { var o = r.t + c, u = r[o]; if ((2 === r.G || 1 === r.G && !t.Z.Y) && (i["s-sc"] = u ? n(r, i.mode) : n(r)), u) {
    ...
    case 12: return [2];
} }); }); }, _ = function (n, t, e, r, i, o, u) { (u = n.On.get(t)) || n.On.set(t, u = {}), r !== u[e] && (u[e] = r, n.gn.get(t) && !n.Cn && t["s-rn"] && S(n, t, i)); }, T = function (n, t, e, r) { Object.defineProperty(n, t, { configurable: !0, get: e, set: r }); }, W = function (n, t, e, r, i, o) { try {
    ...
    } })(n, f, e, r, u, i, o); }); }(n, o, t, i, e, r), function u(n, t, e) { if (t) {
        var r = n._n.get(e);
    ...
    t.addEventListener("e", null, Object.defineProperty({}, "passive", { get: function () { return i.Nn = !0; } }));
...
catch (n) { } return i; }(d, r, i), y = h.J.documentElement, w = r["s-defined"] = r["s-defined"] || {}, b = { Z: h, u: function (n, t) { r.customElements.get(n.t) || (function (n, t, e, r, i) { if (e.connectedCallback = function () { (function (n, t, e) { n.mn.delete(e), n.xn.has(e) || (n.rt = !0, n.yn.add(e), n.xn.set(e, !0), function (n, t, e) { for (e = t; e = n.Z.Xn(e);)
        if (n.it(e)) {
        ...
        catch (n) { } return 1 === t.G && n.Y && !e.shadowRoot && n.et(e, { mode: "open" }), r = { Tn: {} }, t.tn && Object.keys(t.tn).forEach(function (o) { (i = t.tn[o].un) && (r.Tn[i] = n.zn(e, i)); }), r; }(n.Z, t, e)), n.ut(t, e); })); })(n, t, this); }, e.disconnectedCallback = function () { (function (n, t) { !n.ft && function (n, t) { for (; t;) {
        if (!n.Bn(t))
            return 9 !== n.Rn(t);
        t = n.Bn(t);
    } }(n.Z, t) && (n.mn.set(t, !0), P(n, t), M(n.Sn.get(t), !0), n.Z.on(t), n.ct.delete(t), n.l && n.l.removeHost(t), [n.Mn, n.at, n.jn].forEach(function (n) { return n.delete(t); })); })(n, this); }, e["s-init"] = function () { (function (n, t, e, r, i, o) { if (x(n, t) && n.gn.get(t) && !n.mn.has(t) && (!t["s-ld"] || !t["s-ld"].length)) {
        n.ot.set(t, !0), n.st.has(t) || (n.st.set(t, !0), t["s-ld"] = void 0, n.Z.En(t, e));
        try {
    ...
    } S(b, t, f); }); }, Cn: !1, bn: !1, ft: !1, An: l, Mn: new WeakMap, K: new WeakMap, xn: new WeakMap, ct: new WeakMap, st: new WeakMap, ot: new WeakMap, _n: new WeakMap, jn: new WeakMap, gn: new WeakMap, mn: new WeakMap, wn: new WeakMap, at: new WeakMap, vt: new WeakMap, Sn: new WeakMap, On: new WeakMap, yn: new Set, Pn: [] }; return t.isServer = t.isPrerender = !(t.isClient = !0), t.window = r, t.location = r.location, t.document = i, t.resourcesUrl = t.publicPath = o, b.Wn = t.emit = function (n, e, r) { return h.nt(n, t.eventNameFn ? t.eventNameFn(e) : e, r); }, d.h = e, d.Context = t, d.onReady = function () { return new Promise(function (n) { return b.queue.write(function () { return b.yn.size ? b.Pn.push(n) : n(); }); }); }, b.render = function (n, t) { var e, r, i, o, u, f, c, a = function (i, l, p, d, h, y, w, b, M) { if (b = l.vchildren[p], e || (o = !0, "slot" === b.vtag && (r && t.En(d, r + "-s"), b.vchildren ? b.pt = !0 : b.dt = !0)), v(b.vtext))
    b.i = t.Dn(b.vtext);
else if (b.dt)
    b.i = t.Dn("");
else {
    if (y = b.i = g || "svg" === b.vtag ? t.Ln("http://www.w3.org/2000/svg", b.vtag) : t.V(b.pt ? "slot-fb" : b.vtag), n.it(y) && n.ot.delete(c), g = "svg" === b.vtag || "foreignObject" !== b.vtag && g, m(n, null, b, g), v(r) && y["s-si"] !== r && t.En(y, y["s-si"] = r), b.vchildren)
    ...
    for (n.ft = !0, h = 0; h < M.length; h++) {
        for (y = M[h], k = t.Bn(y.yt), $ = t.In(y.yt), m = y.ht["s-ol"]; m = t.Gn(m);)
            if ((g = m["s-nr"]) && g && g["s-sn"] === y.ht["s-sn"] && k === t.Bn(g) && (g = t.In(g)) && g && !g["s-nr"]) {
                $ = g;
                break;
            }
    ...
    n.ft = !1;
} return i && b(l.i), M.length = 0, l; }; }(b, h), y["s-ld"] = [], y["s-rn"] = !0, y["s-init"] = function () { b.ot.set(y, d.loaded = b.bn = !0), h.nt(r, "appload", { detail: { namespace: n } }); }, function (n, t, e, r, i, o) { if (t.componentOnReady = function (t, e) { if (!t.nodeName.includes("-"))
